            ...
            <div className="relative z-10 container mx-auto px-4 pt-32 pb-24">
                <FadeIn direction="down">
                    <div className="text-center mb-12 relative z-10 py-8">
                        ...
                        <p className="text-xl max-w-2xl mx-auto drop-shadow-sm font-sans"
                    ...
                    {/* Search Bar */}
                    <div className="flex flex-col md:flex-row gap-4 mb-6 max-w-2xl mx-auto p-2 backdrop-blur-md rounded-2xl border shadow-md"
                        ...
                        <div className="flex-1 relative group">
                            ...
                            <input
                                ...
                                className="w-full bg-transparent border-none rounded-xl py-4 pl-12 pr-4 focus:outline-none placeholder-gray-400 font-sans"
                    ...
                    <div className="flex flex-wrap justify-center gap-2 mb-12 max-w-2xl mx-auto">
                        {categories.map((cat) => (
                            <button
                                ...
                                style={activeCategory !== cat ? { backgroundColor: 'var(--card-bg)', color: 'var(--card-title)', borderColor: 'var(--card-muted)' } : undefined}
                            >
                                {cat}
                            </button>
                        ))}
